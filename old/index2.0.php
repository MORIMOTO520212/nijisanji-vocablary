    ...
    <head>
        ...
        <script>
            ...
            $(window).scroll(function() {
                ...
                console.log(window.pageYOffset+document.getElementById("target").getBoundingClientRect().top-1000);// 遅延ロードさせるスクロール位置
                // topscroll - continue
                if(sessionStorage.getItem('jscl') > window.pageYOffset+document.getElementById("target").getBoundingClientRect().top-1000){
                    if(lagyLoad==true){
                        ...
                        valueStage.insertAdjacentHTML("beforeend", sources);
                        // MOVE TO POINT //
                        $(window).scrollTop(scrollIn);
                    }
                }
            });
        </script>
    ...
    <body>
        ...
        <script>
            ...
            function activeorder(){
                ...
                console.log(window.pageYOffset+document.getElementById("target").getBoundingClientRect().top-1000);
